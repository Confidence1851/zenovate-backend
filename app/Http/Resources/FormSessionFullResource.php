...
class FormSessionFullResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        $products = empty($payment->products) ? Product::whereIn('id', $selected_products->pluck('product_id'))->get() : [];
        ...
        return [
            ...
            'completed_payment' => PaymentResource::make($payment),
