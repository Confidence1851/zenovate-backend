            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1">
                    <button class="btn btn-link p-0 position-relative" type="button" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <picture>
                            <img class="f-w-10 rounded-circle" src="{{ asset("user.png")}}" alt="">
                        </picture>
                    ...
                    <ul class="dropdown-menu dropdown-md dropdown-menu-end" aria-labelledby="profileDropdown">
                        ...
                        <li class="d-flex py-2 align-items-start">
                            <button class="btn-icon bg-primary-faded text-primary fw-bolder me-3">{{auth()->user()->name[0] }}</button>
                        ...
                        <li><a class="dropdown-item d-flex align-items-center" href="#" onclick="return document.getElementById('logoutBtn').click();">Logout</a></li>
